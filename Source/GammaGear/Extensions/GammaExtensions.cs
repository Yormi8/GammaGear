    ...
    public static class GammaExtensions
    {
        ...
        public static Uri ToIconUri(this ItemType type)
        {
            return type switch
            {
                ...
                ItemType.TearJewel => new Uri(@"pack://application:,,,/GammaGear;component/Assets/Images/(Icon)_Equipment_TearJewel.png"),
                ItemType.CircleJewel => new Uri(@"pack://application:,,,/GammaGear;component/Assets/Images/(Icon)_Equipment_CircleJewel.png"),
